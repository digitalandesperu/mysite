const SuitcaseIcon = (props) => (
  <>
    <div className="inline-block align-middle p-4 rounded-2xl p-2 border-none bg-[#157FB7]">
      <svg xmlns="http://www.w3.org/2000/svg" width={props?.width ?? "25px"} height={props?.height ?? "25px"} viewBox="0 0 512 512">
        <path
          fill="#FFFFFF"
