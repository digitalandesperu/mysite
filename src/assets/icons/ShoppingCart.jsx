export const ShoppingCart = (props) => (
  <>
    <div className="inline-block align-middle p-4 rounded-2xl p-2 bg-[#724ECF]">
      <svg xmlns="http://www.w3.org/2000/svg" width={props?.width ?? "1em"} height={props?.height ?? "1em"} viewBox="0 0 256 256" {...props}>
        <path
          fill="#ffffff"
