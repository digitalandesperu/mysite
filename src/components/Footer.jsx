    ...
    <footer className="relative border-t border-slate-800 bg-[#0b1220] text-slate-300">
      ...
      <div className="max-w-6xl mx-auto px-6 py-14 grid gap-10 md:grid-cols-4">
        ...
        <div>
          ...
          <p className="mt-3 text-sm text-slate-400 text-justify">
            Desarrollo web moderno, personalizados y soluciones con IA para hacer crecer tu negocio.
          </p>
        ...
        <nav className="text-sm">
          ...
          <ul className="space-y-2">
            ...
            <li><a href="#por-que-elegirnos" className="hover:text-cyan-400">Porque elegirnos</a></li>
        ...
        <address className="not-italic text-sm">
          ...
          <p className="text-slate-400">SJL, Lima, Perú · Atención Lun–Sáb 9:00–19:00</p>
          <p className="mt-2">
            <a href="mailto:digitalandesperu@gmail.com" className="hover:text-cyan-400">digitalandesperu@gmail.com</a>
          </p>
          <p className="mt-1">
            <a href="tel:+51998994999" className="hover:text-cyan-400">998 994 999</a>
          </p>
          <div className="mt-4">
            <a
              href="https://wa.me/51998994999?text=Hola%20Digital%20Andes,%20quiero%20una%20cotización"
